Contributing to GalleonCoin Core
============================

The GalleonCoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/galleoncoin-project/galleoncoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the GalleonCoin Core project, and is not to be
confused with overall GalleonCoin Network Protocol consensus changes.

Whether a pull request is merged into GalleonCoin Core rests with the project merge
...
Patches that change GalleonCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the GalleonCoin consensus, it must have been
...
The project leader is the release manager for each GalleonCoin Core release.
