...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/galleoncoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/galleoncoin-cli.cpp \
           src/galleoncoin-tx.cpp \
           src/galleoncoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/galleoncoin.qrc src/qt/galleoncoin_locale.qrc

TRANSLATIONS += src/qt/locale/galleoncoin_bg.ts \
                src/qt/locale/galleoncoin_de.ts \
                src/qt/locale/galleoncoin_en.ts \
                src/qt/locale/galleoncoin_es.ts \
                src/qt/locale/galleoncoin_fi.ts \
                src/qt/locale/galleoncoin_fr.ts \
                src/qt/locale/galleoncoin_it.ts \
                src/qt/locale/galleoncoin_ja.ts \
                src/qt/locale/galleoncoin_pl.ts \
                src/qt/locale/galleoncoin_pt.ts \
                src/qt/locale/galleoncoin_ru.ts \
                src/qt/locale/galleoncoin_sk.ts \
                src/qt/locale/galleoncoin_sv.ts \
                src/qt/locale/galleoncoin_vi.ts \
                src/qt/locale/galleoncoin_zh_CN.ts \
                src/qt/locale/galleoncoin_zh_TW.ts
