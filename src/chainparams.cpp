...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("00000c69d386422d24095f6343e2f18562bd022bee81a13731136dd075da11eb"))
    (1, uint256("000004a8da58c6db60a8c82ef5fa97f0b6c4a0b3053065311b6a630743a31747"))
    (15, uint256("00000551d359bc81c73c328fc16c39455109a4cf49dbd996fa4714dd63832057"))
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04ce554fdc8731cca80f1807046279e814d70cc6f834cc8dc89e3bca885026d7a7c0a38c674f5ef5e30f0a068523bc6686f95af94ccefb8b0e570bbfa166671ff0");
        nDefaultPort = 46976;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // GalleonCoin starting difficulty is 1 / 2^12
        ...
        nEnforceNewSporkKey = 1636952065;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = " El Galeon San Pedro hizo un viaje de ida y vuelta";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1000 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("041cf70e79738ea0f2a93e7fd5217cdead42ab15b2ae74a0d59421bd13b73b0006467a6a85e2a7640a96eec936a242591d3cfd18a9d56676c287d758f7925ec325") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1636952065;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 20833872;
        ...
        strSporkKey = "044bfc33ed7d73a1fa7d8193c802d2671d5928f4d4779fe2866d10b27a5e90dca8f7346a622f1c63e3d7f313d6f32bb7c5a4a701db0c205c1db99af97b7c0c743c";
        strSporkKeyOld = "04B433E6598390C992F4F022F20D3B4CBBE691652EE7C48243B81701CBDB7CC7D7BF0EE09E154E6FCBF2043D65AF4E9E97B89B5DBAF830D83B9B7F469A6C45A717";
        strObfuscationPoolDummyAddress = "19tEz87rHmY3jnhYY6VHYZUUqhTzmAHRuL";
        nStartMasternodePayments = 1636952065;
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zgale to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("049058c7c0b6448f2221134262e3ffe700151a1e810957d4ff5bd18cf40a7184593cca640417c16793cb321742e7d5213c10a025255337118be4e108e2245b4ac4");
        nDefaultPort = 56976;
        nEnforceBlockUpgradeMajority = 0;
        nRejectBlockOutdatedMajority = 0;
        nToCheckBlockUpgradeMajority = 0;
        ...
        // Testnet galleoncoin BIP44 coin type is '1' (All coin's testnet default)
        ...
        strSporkKey = "04c20edf23f7f60c948e3c3737cee9776e68ed9715942757cf5267c180b62b7cdb2026aa166cc3aedb1366a5514799881ccde41d5a019b4d42743aa1705a4bd15e";
        strSporkKeyOld = "04348C2F50F90267E64FACC65BFDC9D0EB147D090872FB97ABAE92E9A36E6CA60983E28E741F8E7277B11A7479B626AC115BA31463AC48178A5075C5A9319D4A38";
        strObfuscationPoolDummyAddress = "MSoxUym81JCAoPPkZyXNkNyRaQA98QDHWw";
        nStartMasternodePayments = 1636952065;
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 0;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // GalleonCoin: 1 day
        nTargetSpacing = 1 * 60;        // GalleonCoin: 1 minutes
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000c69d386422d24095f6343e2f18562bd022bee81a13731136dd075da11eb"));
        //assert(hashGenesisBlock == uint256("0x304f1e885dd7debf8082402dacae76aa7c45ead7bd0ee79f1d16709dbe9b79e0"));
