...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GalleonCoin Core galleoncoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  galleoncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded galleoncoin transaction") + "\n" +
                               "  galleoncoin-tx [options] -create [commands]   " + _("Create hex-encoded galleoncoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded galleoncoin transaction
