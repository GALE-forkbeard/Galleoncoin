...
/** Utility functions used by the GalleonCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render GalleonCoin addresses in monospace font
...
// Parse "galleoncoin:" URI into recipient object, return true on successful parsing
