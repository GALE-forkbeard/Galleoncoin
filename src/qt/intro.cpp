...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("GalleonCoin Core"),
     ...
     * override -datadir in the galleoncoin.conf file in the default data directory
     * (to be consistent with galleoncoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
