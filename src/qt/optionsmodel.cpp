...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::GALE);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeGalleonCoinAmount"))
        SoftSetArg("-anonymizegalleoncoinamount", settings.value("nAnonymizeGalleonCoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in galleoncoin.cpp during shotdown to also remove the window positions
