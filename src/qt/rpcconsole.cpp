                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzGALEPathCustom = GetArg("-zgalebackuppath", "");
    ...
    if(!strzGALEPathCustom.empty()) {
        ui->wallet_customzgalebackuppath->setText(QString::fromStdString(strzGALEPathCustom));
        ui->wallet_customzgalebackuppath_label->setVisible(true);
        ui->wallet_customzgalebackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzGALEPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the GalleonCoin RPC console.") + "<br>" +
