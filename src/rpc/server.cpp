...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop GalleonCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "GalleonCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GalleonCoin features */
        {"galleoncoin", "listmasternodes", &listmasternodes, true, true, false},
        {"galleoncoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"galleoncoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"galleoncoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"galleoncoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"galleoncoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"galleoncoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"galleoncoin", "masternodedebug", &masternodedebug, true, true, false},
        {"galleoncoin", "startmasternode", &startmasternode, true, true, false},
        {"galleoncoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"galleoncoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"galleoncoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"galleoncoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"galleoncoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"galleoncoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"galleoncoin", "preparebudget", &preparebudget, true, true, false},
        {"galleoncoin", "submitbudget", &submitbudget, true, true, false},
        {"galleoncoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"galleoncoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"galleoncoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"galleoncoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"galleoncoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"galleoncoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"galleoncoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"galleoncoin", "checkbudgets", &checkbudgets, true, true, false},
        {"galleoncoin", "mnsync", &mnsync, true, true, false},
        {"galleoncoin", "spork", &spork, true, true, false},
        {"galleoncoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzgaleseed", &getzgaleseed, false, false, true},
        {"zerocoin", "setzgaleseed", &setzgaleseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzgale", &searchdzgale, false, false, true},
        {"zerocoin", "dzgalestate", &dzgalestate, false, false, true},
...
{
    return "> galleoncoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:46975/\n";
}
