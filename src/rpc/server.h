...
/**
 * GalleonCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZgaleSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzgaleseed(const UniValue& params, bool fHelp);
extern UniValue getzgaleseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzgale(const UniValue& params, bool fHelp);
extern UniValue dzgalestate(const UniValue& params, bool fHelp);
