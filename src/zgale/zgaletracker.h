...
#ifndef GalleonCoin_ZGALETRACKER_H
#define GalleonCoin_ZGALETRACKER_H
...
public:
    CzGALETracker(std::string strWalletFile);
    ~CzGALETracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzGALEWallet* zGALEWallet = NULL);
...
#endif //GalleonCoin_ZGALETRACKER_H
