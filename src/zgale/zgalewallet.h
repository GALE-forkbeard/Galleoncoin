...
#ifndef GalleonCoin_ZGALEWALLET_H
#define GalleonCoin_ZGALEWALLET_H
...
public:
    CzGALEWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZGALE(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZGALE(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //GalleonCoin_ZGALEWALLET_H
