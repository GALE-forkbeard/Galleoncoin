...
from fake_stake.base_test import GalleonCoin_FakeStakeTest

class zGALEwrappedSerialsTest(GalleonCoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zGALEs..." % DENOM_TO_USE)
